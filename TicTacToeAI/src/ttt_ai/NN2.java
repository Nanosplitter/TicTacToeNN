...
public class NN2 implements Comparable<NN2>, Serializable {
	/**
	 * 
	 */
	...
	public NN2(int numInputs, int numOutputs, int numHiddenLayers, int widthHiddenLayers) {
...
//						System.out.println("Before: " + c.getWeight());
						c.adjustWeight((float) rnd.nextDouble() * (rnd.nextInt(3) + 1));
//						System.out.println("After: " + c.getWeight());
					} else {
//						System.out.println("Before decrease: " + c.getWeight());
						c.adjustWeight((float) rnd.nextDouble() * (float) -1 * (rnd.nextInt(3) + 1));
